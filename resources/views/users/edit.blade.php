        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('users.id.update', array('id'=>Auth::user()->id)) }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <label for="username" class="col-md-4 control-label">Curent photo:</label>
                            <img src="{{asset('images')}}/{{Auth::user()->photo}}" height="100">
                        </div>
